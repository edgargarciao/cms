                        ...
                        <div class="page-header float-left">
                        	<div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#"> Eliminar Red social</li>
                            	</ol>
                            </div>
						</div>    
                </div>
                	...
                	<div class="col-md-12">                	
                    	...
                    	<div class="card">
                        	...
                        	<div class="card-header">
                            	<strong class="card-title">Eliminar Red social</strong>
                        	</div>
                        	<div class="card-body">
                        		...
                        		<!-- Formulario -->
                        		<form:form id="formRedSocial" action="borrarRedSocial" method="post" modelAttribute="redSocial" enctype="multipart/form-data">
                                	...
                                	<div class="form-group">
                                    	<label for="text-input" class=" form-control-label">¿Estás seguro de eliminar la red social "${redSocial.nombre}"?</label>                                		
                                	</div> 
