                        ...
                        <div class="page-header float-left">
                        	<div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="#"> Eliminar Contacto</li>
                            	</ol>
                            </div>
						</div>    
                </div>
                	...
                	<div class="col-md-12">                	
                    	...
                    	<div class="card">
                        	...
                        	<div class="card-header">
                            	<strong class="card-title">Eliminar contacto</strong>
                        	</div>
                        	<div class="card-body">
                        		...
                        		<!-- Formulario -->
                        		<form:form id="formContacto" action="borrarContacto" method="post" modelAttribute="contacto">
                                	...
                                	<div class="form-group">
                                    	<label for="text-input" class=" form-control-label">¿Estás seguro de eliminar el contacto "${contacto.nombre}"?</label>                                		
                                	</div> 
